...
# 4/5AHfe19bEZ8zm0dZNbpdoxcAzojj3E3BQHLHFl13Zsk3Xp_i4lh-3Cc
from google.colab import drive

drive.mount("/content/drive", force_remount=True)
data_dir = "drive/My Drive/thesis-data"
...
mask_test_neg = np.logical_and(
    ~mask_targets, np.random.binomial(1, 0.08, mask_targets.size).astype(np.bool)
)
