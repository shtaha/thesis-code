...
class StandardDCOPF(UnitConverter, PyomoMixin):
    ...
    def _build_variables(self):
        ...
        self._build_variables_standard_deltas()  # Bus voltage angles and bounds
        self._build_variables_standard_deltas()  # Power line flows and bounds
...
class TopologyOptimizationDCOPF(StandardDCOPF):
    ...
    def _build_variables(self):
        self._build_variables_standard_generators()  # Generator productions and bounds
        self._build_variables_standard_deltas()  # Bus voltage angles and bounds
        self._build_variables_standard_deltas()  # Power line flows
